...
mkfs.xfs /dev/xvdb
echo "/dev/xvdb		/u01				xfs     defaults        0 0" >> /etc/fstab
...
cd /u01
aws s3 cp s3://installer/linuxx64_12201_database.zip   /u01/linuxx64_12201_database.zip

unzip /u01/linuxx64_12201_database.zip
chown -R oracle:dba /u01
chmod 755 oracle.sh
cp oracle.sh /etc/profile.d/oracle.sh
cp -r .ssh/ /home/oracle/
